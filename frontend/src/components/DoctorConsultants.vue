      ...
      <div class="content-wrapper">
        ...
        <div class="page-header">
          <div class="header-left">
            <h2 class="page-title">My Consultations</h2>
            <p class="page-subtitle">Manage your patient consultations</p>
          </div>
                  ...
                  >
                    ...
                    <div class="consultant-info">
                      <div class="info-header">
                        <h4 class="patient-name">{{ consultation.patient?.user?.firstName }} {{ consultation.patient?.user?.lastName }}</h4>
                        <span class="consultant-status upcoming">Upcoming</span>
                      </div>
                      <p class="patient-detail">Age: {{ consultation.patient?.age }} • {{ consultation.patient?.gender }}</p>
                      ...
                      <div class="consultation-subject">
                        <strong>Subject:</strong> {{ consultation.subject }}
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    calculateStats() {
      ...
      const uniquePatients = new Set(this.consultations.map(c => c.patient?.id)).size;
      this.stats.totalPatients = uniquePatients;
      
      // Get average rating from doctor data (assuming it's in the first consultation's doctor object)
      if (this.consultations.length > 0 && this.consultations[0].doctor) {
        this.stats.averageRating = this.consultations[0].doctor.averageRating || 0;
        this.stats.totalReviews = this.consultations[0].doctor.totalReviews || 0;
      }
    },
...
<style scoped>
/* All your existing styles from PatientConsultants.vue remain exactly the same */
/* Just add these additional styles */
...
.consultation-subject strong {
  color: #2d3748;
  font-weight: 600;
}

/* Keep all other styles from PatientConsultations.vue */
